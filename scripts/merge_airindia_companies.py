# -*- coding: utf-8 -*-
"""
合并 AIR INDIA EXPRESS 重复公司

保留: AIR INDIA EXPRESS
合并: AIR INDIA EXPRESS LIMITED

运行方式: python scripts/merge_airindia_companies.py
确认执行: python scripts/merge_airindia_companies.py --confirm
"""
...
# 保留的公司名称
KEEP_COMPANY = 'AIR INDIA EXPRESS'
...
def main():
    parser = argparse.ArgumentParser(description='合并 AIR INDIA EXPRESS 重复公司')
    ...
    with app.app_context():
        print("=" * 70)
        print("       合并 AIR INDIA EXPRESS 重复公司")
        print("=" * 70)
        ...
        if dry_run:
            ...
            print(f"  python scripts/merge_airindia_companies.py --confirm")
