...
# -*- coding: utf-8 -*-
"""
脚本名称：create_zhang_zhuan_account.py
功能描述：为员工ZHANG ZHUAN创建指定账号
创建日期：2024-01-XX
作者：Assistant
版本：1.0
"""
...
def create_zhang_zhuan_account():
    """为员工ZHANG ZHUAN创建指定账号"""
    app = create_app()
...
def main():
    """主函数"""
    print("开始创建 ZHANG ZHUAN 员工账户...")
    
    success = create_zhang_zhuan_account()
    ...
    if success:
        ...
        print("=" * 50)
        print("\n📋 最终账号信息:")
        print("   用户名: zhang zhuan")
        print("   邮箱: zhangzhuan@mytravel.com")
        print("   密码: zhangzhuan123")
