...
class TourGroup(db.Model):
    ...
    pax = db.Column(db.Integer, nullable=False, comment='总人数（= 大人 + 小孩，保存时自动汇总）')
    adult_count = db.Column(db.Integer, nullable=True, comment='大人人数')
    child_count = db.Column(db.Integer, nullable=True, comment='小孩人数')
