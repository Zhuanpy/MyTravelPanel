...
from App_new.business.visa.models import VisaCountries, VisaTypes, VisaDocuments, VisaProject  # 绝对导入，确保在任何上下文可用
from App_new.business.visa.models.Visamodels import VisaLinks
