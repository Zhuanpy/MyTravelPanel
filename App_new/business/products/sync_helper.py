...
def sync_tour_product_to_unified(tour_product, created_by=None):
    ...
    if unified:
        ...
        unified.short_description = tour_product.highlights[:500] if tour_product.highlights else None
        unified.description = tour_product.product_description
        unified.highlights = tour_product.highlights
        ...
        unified = ProductsUnified(
            ...
            short_description=tour_product.highlights[:500] if tour_product.highlights else None,
            description=tour_product.product_description,
            highlights=tour_product.highlights,
