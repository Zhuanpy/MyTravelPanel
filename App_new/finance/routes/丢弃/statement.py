...
#
#
# @statement_blue.route('/uob_to_company', methods=['GET', 'POST'])
# @csrf.exempt
# def uob_to_company():
#     if request.method == 'GET':
#         return redirect(url_for('statement_routes.uob_bank'))
...
#
#
# @statement_blue.route('/uob_latest_company_statement', methods=['GET', 'POST'])
# @csrf.exempt
...
#
#
# @statement_blue.route('/uob_latest_self_statement', methods=['GET', 'POST'])
# @csrf.exempt
...
#
#
# @statement_blue.route('/download_ocbc_statement/<statement_number>')
# @login_required
# @staff_only
...
#
#
# @statement_blue.route('/ocbc_tx_update', methods=['POST'])
# @csrf.exempt
# @login_required
# @staff_only
# def ocbc_tx_update():
...
#
#
# @statement_blue.route('/ocbc_tx_confirm', methods=['POST'])
# @csrf.exempt
# @login_required
# @staff_only
# def ocbc_tx_confirm():
...
#
#
# @statement_blue.route('/download_cmb_statement/<statement_number>')
# @login_required
# @staff_only
...
#
#
# @statement_blue.route('/cmb_tx_update', methods=['POST'])
# @csrf.exempt
# @login_required
# @staff_only
# def cmb_tx_update():
...
#
#
# @statement_blue.route('/cmb_tx_confirm', methods=['POST'])
# @csrf.exempt
# @login_required
# @staff_only
# def cmb_tx_confirm():
